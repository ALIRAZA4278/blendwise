            ...
            <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl">
                ...
                <ul className="space-y-2 pl-6">
                  ...
                  <li>ii. Live Chat</li>
                  <li>iii. Email: <a href="mailto:info@blendwisesolutions.com" className="text-[#8a21f0] hover:text-[#35a5e8] font-semibold">info@blendwisesolutions.com</a></li>
                </ul>
              </div>
              ...
              <p>
                If you have any questions or concerns about our Refund Policy, please contact us at <a href="mailto:info@blendwisesolutions.com" className="text-[#8a21f0] hover:text-[#35a5e8] font-semibold">info@blendwisesolutions.com</a>.
              </p>
            </div>
          </div>
        </div>
