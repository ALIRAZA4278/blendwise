    ...
    <div>
      ...
      <section className="relative w-full min-h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          {/* Floating Orbs */}
          <div className="absolute top-10 left-5 w-48 h-48 bg-[#35a5e8]/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 right-5 w-64 h-64 bg-[#8a21f0]/10 rounded-full blur-3xl"></div>
          <div className="absolute top-1/3 right-1/4 w-32 h-32 bg-[#35a5e8]/5 rounded-full blur-2xl"></div>
          ...
          <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-center" style={{ minHeight: '60vh', paddingTop: '100px' }}>
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
                ...
                <button onClick={() => setIsModalOpen(true)} className="bg-white hover:bg-gray-100 text-[#8a21f0] font-bold px-6 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-xs">
                  Live Chat
                </button>
              </div>
            </div>
      ...
      <section className="relative w-full py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-black bg-gradient-to-r from-[#8a21f0] to-[#35a5e8] bg-clip-text text-transparent mb-4">
              PRIVACY & SECURITY
            </h2>
      ...
      <section className="relative w-full py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              If you no longer wish to receive our newsletter and promotional communications, you may opt-out of receiving them by following the instructions included in each newsletter or communication or by emailing us at <a href="mailto:info@blendwisesolutions.com" className="text-[#8a21f0] hover:text-[#35a5e8] font-semibold">info@blendwisesolutions.com</a> or calling us at <a href="tel:+17866190117" className="text-[#8a21f0] hover:text-[#35a5e8] font-semibold">+1 (786) 619-0117</a>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative w-full py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              The information of our clients is secure, as it is protected during transmission by the use of the Secure Sockets Layer (SSL) Software which encrypts the information the client puts in. We follow generally accepted industry standards to protect the personal information submitted to us, both during transmission and once we receive it. No method of transmission over the Internet, or method of electronic storage, is 100% secure, however. Therefore, while we strive to use commercially acceptable means to protect your personal information, we cannot guarantee its absolute security. If you have any questions about security on our Web site, you can send email us at <a href="mailto:info@blendwisesolutions.com" className="text-[#8a21f0] hover:text-[#35a5e8] font-semibold">info@blendwisesolutions.com</a>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative w-full py-16 bg-gradient-to-r from-[#8a21f0] to-[#35a5e8]">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <button onClick={() => setIsModalOpen(true)} className="bg-white text-[#8a21f0] hover:bg-gray-100 font-bold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-xs">
            Contact Us Today
          </button>
        </div>
      </section>
