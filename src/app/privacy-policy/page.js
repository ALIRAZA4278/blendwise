      ...
      <section className="relative w-full py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              If you no longer wish to receive our newsletter and promotional communications, you may opt-out of receiving them by following the instructions included in each newsletter or communication or by emailing us at <a href="mailto:info@blendwise.com" className="text-[#8a21f0] hover:text-[#35a5e8] font-semibold">info@blendwise.com</a> or calling us at <a href="tel:6469939010" className="text-[#8a21f0] hover:text-[#35a5e8] font-semibold">(646) 993-9010</a>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative w-full py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-sm text-gray-700 leading-relaxed">
              The information of our clients is secure, as it is protected during transmission by the use of the Secure Sockets Layer (SSL) Software which encrypts the information the client puts in. We follow generally accepted industry standards to protect the personal information submitted to us, both during transmission and once we receive it. No method of transmission over the Internet, or method of electronic storage, is 100% secure, however. Therefore, while we strive to use commercially acceptable means to protect your personal information, we cannot guarantee its absolute security. If you have any questions about security on our Web site, you can send email us at <a href="mailto:info@blendwise.com" className="text-[#8a21f0] hover:text-[#35a5e8] font-semibold">info@blendwise.com</a>.
            </p>
          </div>
        </div>
      </section>
