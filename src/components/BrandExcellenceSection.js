            ...
            <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
              ...
              <div className="text-white space-y-3">
                <div className="flex items-center gap-3 group">
                  ...
                  <a href="tel:+17866190117" className="text-2xl font-black hover:scale-105 transition-transform duration-300">
                    +1 (786) 619-0117
                  </a>
                </div>
                <div className="flex items-center gap-3 group">
                  ...
                  <a href="mailto:info@blendwisesolutions.com" className="text-xl font-bold hover:scale-105 transition-transform duration-300">
                    info@blendwisesolutions.com
                  </a>
                </div>
              </div>
