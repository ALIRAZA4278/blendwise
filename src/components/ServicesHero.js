...
const ServicesHero = () => {
  ...
  const customizedServices = [
    { id: 1, icon: '📦', title: 'Custom Package', description: 'Build a tailored package that fits your unique business needs and budget', action: 'modal' },
    { id: 2, icon: '💬', title: 'Live Chat', description: 'Chat with our experts in real-time and get instant answers to your queries', action: 'modal' },
    { id: 3, icon: '🎧', title: 'Call +1 (786) 619-0117', description: 'Speak directly with our team for personalized guidance and support', action: 'tel:+17866190117' },
    { id: 4, icon: '📞', title: 'Request Call Back', description: 'Schedule a convenient callback and we\'ll reach out at your preferred time', action: 'modal' }
  ];
            ...
            <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6 max-w-xl animate-fadeInLeft">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
                  ...
                  <a href="tel:+17866190117" className="flex items-center gap-2 text-white font-bold text-sm hover:text-[#35a5e8] transition-colors">
                    <span>📞</span>
                    <span>+1 (786) 619-0117</span>
                  </a>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="bg-white rounded-2xl shadow-lg p-8 border-t-4 border-[#8a21f0] hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-[10px] text-gray-600">
                Successfully delivered over 1,500 projects across web design, branding, and digital marketing for clients worldwide.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-t-4 border-[#8a21f0] hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-[10px] text-gray-600">
                A dedicated team of skilled designers, developers, and strategists committed to delivering exceptional results.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-t-4 border-[#8a21f0] hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-sm font-bold text-gray-900 mb-2">5 Star Ratings</p>
              <p className="text-[10px] text-gray-600">
                Our clients consistently rate us 5 stars for quality, communication, and on-time delivery of every project.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border-t-4 border-[#8a21f0] hover:shadow-2xl transition-all duration-300 hover:scale-105">
              ...
              <p className="text-[10px] text-gray-600">
                Recognized with multiple industry awards for outstanding creativity and innovation in digital solutions.
              </p>
            </div>
          </div>
