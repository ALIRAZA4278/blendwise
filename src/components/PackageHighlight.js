        ...
        <div className="relative bg-white rounded-xl shadow-lg overflow-hidden border-2 border-gray-200">
          ...
          <div className="p-4 md:p-5">
            ...
            <div className="text-center mb-4">
              ...
              <p className="text-gray-700 max-w-2xl mx-auto" style={{ fontSize: '14px' }}>
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-3">
                ...
                <div className="text-center lg:text-left">
                  <div className="flex flex-col sm:flex-row items-center gap-2 mb-2">
                    <a href="tel:6469939010" className="group flex items-center gap-1.5 bg-white border border-[#35a5e8] hover:border-[#2590d8] rounded-full px-3 py-1.5 transition-all duration-300 shadow-sm hover:shadow-md" style={{ textDecoration: 'none' }}>
                    ...
                    <button className="flex items-center gap-1.5 bg-[#8a21f0] hover:bg-[#7a1dd8] text-white font-bold px-3 py-1.5 rounded-full transition-all duration-300 shadow-md text-xs">
                      <span className="text-xs">💬</span>
                      <span>LIVE CHAT</span>
                    </button>
                  </div>
                ...
                <div className="text-center">
                  ...
                  <button className="group relative bg-[#8a21f0] hover:bg-[#7a1dd8] text-white font-black px-6 py-2 rounded-full transition-all duration-300 shadow-lg mb-1.5 w-full text-xs">
                    🎉 ORDER NOW
                  </button>
                  <p className="text-[10px] font-bold text-gray-700 mb-1">
                    20% more OFF on Next Order 🎁
                  </p>
                  <button className="text-[#35a5e8] font-bold text-[10px] hover:opacity-80 transition-opacity underline uppercase">
                    VIEW DETAILS →
                  </button>
                </div>
              </div>
  ...
  return (
    <div className="flex items-start gap-1.5 group">
      <div className="shrink-0 mt-0.5">
        <div className="w-3 h-3 rounded-full bg-[#8a21f0] flex items-center justify-center shadow-sm">
          <svg className="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          </svg>
        </div>
      </div>
      <p className="text-gray-700 leading-relaxed" style={{ fontSize: '14px' }}>{text}</p>
    </div>
  );
};
