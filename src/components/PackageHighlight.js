              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-3">
                ...
                <div className="text-center lg:text-left animate-fadeInLeft animation-delay-800">
                  <div className="flex flex-col sm:flex-row items-center gap-2 mb-2">
                    <a href="tel:+17866190117" className="group flex items-center gap-1.5 bg-white border border-[#35a5e8] hover:border-[#2590d8] rounded-full px-3 py-1.5 transition-all duration-300 shadow-sm hover:shadow-md hover-scale" style={{ textDecoration: 'none' }}>
