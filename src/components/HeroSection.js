  ...
  return (
    <section className="relative w-full flex flex-col overflow-hidden">
      ...
      <div className="relative w-full min-h-[85vh] flex flex-col">
        ...
        <div className="relative z-10 flex-1 w-full max-w-6xl mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center" style={{ paddingTop: '120px', paddingBottom: '40px' }}>
          ...
          <div className="text-white space-y-4 animate-fadeInLeft">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-3 animate-fadeInUp animation-delay-600">
              ...
              <a href="tel:+17866190117" className="flex items-center gap-2 bg-white/10 backdrop-blur-md border-2 border-white/30 rounded-full px-3 py-1.5 hover:bg-white/20 transition-all duration-300">
                <span className="text-base">📞</span>
                <div>
                  <p className="text-[10px] font-semibold">Call Us: </p>
                  <p className="text-xs font-black text-[#35a5e8]">+1 (786) 619-0117</p>
                </div>
              </a>
            </div>
